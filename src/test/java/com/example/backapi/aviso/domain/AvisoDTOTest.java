...
public class AvisoDTOTest {
    ...
    @Test
    public void aviso_deve_conter_um_titulo() {
        String tituloEsperado = "Livro de quimica";
        aviso.setTitulo(tituloEsperado);

        String tituloRetornado = aviso.getTitulo();
    ...
    @Test
    public void aviso_deve_conter_uma_descricao() {

        String descricaoEsperada = "Este livro de quimica é do terceiro ano do ensino medio";
        aviso.setDescricao(descricaoEsperada);

        String descricaoRetornado = aviso.getDescricao();

        assertEquals(descricaoEsperada, descricaoRetornado);
    }

    @Test
    public void aviso_deve_conter_uma_lista_de_links() {
        List<LinkAviso> linksEsperados = Arrays.asList(new LinkAviso("www.globo.com", "Site de noticias"));
        aviso.setLinks(linksEsperados);

        List<LinkAviso> linksRetornados = aviso.getLinks();
    ...
    @Test
    public void aviso_deve_conter_uma_data_de_criacao() {
        Date dataEsperada = new Date();

        aviso.setDataDeCriacao(dataEsperada);
        Date dataRetornada = aviso.getDataDeCriacao();
